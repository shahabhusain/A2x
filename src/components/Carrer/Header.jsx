    ...
    <div className=' bg-[#2E3D32] w-full h-screen rounded-b-2xl'>
         <div className='flex items-center justify-between py-3 px-12'>
             <div className=' flex items-center gap-2'>
                ...
                <h2 className=' flex items-center text-[23px] font-[700] text-[#fff]'><span>A</span><span>2</span><span>Z</span><span>H</span><span>e</span><span>a</span><span>l</span><span>t</span> <span>h</span> <span>C</span><span>a</span><span>r</span><span>e</span></h2>
             </div>
